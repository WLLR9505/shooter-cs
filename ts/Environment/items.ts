...
var pistola = new Arma('P1', [0, 0, 10], 200, 2, 5.5, 10, 2, 'pistola_1.png',
    {
        pArma: [0, 0],
        pMao: [4, 9],
        pCano: [21, 6],
...
var fuzil1 = new Arma('FZ-1A', [0, 0, 30], 1000, 4, 6, 5, 3, 'fuzil_1.png',
    {
        pArma: [0, 0],
        pMao: [25, 12],
        pCano: [57, 6],
...
var FMA = new Arma('FM-A', [0, 0, 20], 1150, 1, 5, 6, 3, 'fm-a.png',
    {
        pArma: [0, 0],
        pMao: [30, 12],
        pCano: [55, 6],
...
var SMMA = new Arma('SMM-A', [0, 0, 25], 670, 2.7, 5.5, 5, 2, 'smm-a.png',
    {
        pArma: [0, 0],
        pMao: [30, 12],
        pCano: [50, 6],
...
var FMB = new Arma('FM-B', [0, 0, 35], 1270, 2, 6, 4, 3, 'fm-b.png',
    {
        pArma: [0, 0],
        pMao: [30, 12],
        pCano: [55, 6],
...
var SMMB = new Arma('SMM-B', [0, 0, 20], 1085, 3, 5, 4.5, 2, 'smm-b.png',
    {
        pArma: [0, 0],
        pMao: [30, 12],
        pCano: [50, 6],
